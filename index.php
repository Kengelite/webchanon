        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-12 text-center">
              <h2 id="text">Asst. Prof. Chanon Dechsupa, Ph.D.</h2>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="./assets/img/AsstProf.jpg" alt="" class="img-fluid">
              </div>
              <h3><a href="#" class="stretched-link">ขอแสดงความยินดีแก่ อ. ดร.ชานนท์ เดชสุภา</a></h3>
              <p>ขอแสดงความยินดี อ. ดร.ชานนท์ เดชสุภา อาจารย์ประจำวิทยาลัยการคอมพิวเตอร์ เนื่องในโอกาสที่ได้รับการแต่งตั้งให้ดำรงตำแหน่ง ผู้ช่วยศาสตราจารย์ ในสาขาวิชาวิศวกรรมคอมพิวเตอร์ อนุสาขาวิชาวิศวกรรมซอฟต์แวร์ ตั้งแต่วันที่ 22 กันยายน 2565 ตามมติสภามหาวิทยาลัยขอนแก่น ในคราวการประชุมครั้งที่ 3/2566 เมื่อวันที่ 1 มีนาคม 2566</p>
            </div>
          </div><!-- End Card Item -->
...
<!-- 
  ...
  // เริ่มการแสดงข้อความทีละตัวอักษร
  function showText() {
